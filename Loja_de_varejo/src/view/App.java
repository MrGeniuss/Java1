...
public class App{
    public static void main(String[] args) {
        ...
        System.out.printf("Atualmente temos %d clientes cadastrados\n", clientes.size());

        var cliente = new Cliente("David Andersen", 999888777, "davi.andersen@gmail.com", LocalDate.of(1999, 7, 2), 1);
        ...
        System.out.printf("Atualmente temos %d produtos cadastrados\n", produtos.size());

        var produto = new Produto("Cabelo Especial", "Capivara Atômica", 3000.00, 400.000, 2);
